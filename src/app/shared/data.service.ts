...
const PUBLIC_CHILD_SUPPORT_EXPENSE = 17;
...
export const PUBLIC_CATEGORY_LIST = {
  ...
  [PUBLIC_CHILD_SUPPORT_EXPENSE]: '養育費',
...
export const publicCategory: Category[] = [
  ...
  {
    value: PUBLIC_CHILD_SUPPORT_EXPENSE,
    viewValue: PUBLIC_CATEGORY_LIST[PUBLIC_CHILD_SUPPORT_EXPENSE],
  },
  {
